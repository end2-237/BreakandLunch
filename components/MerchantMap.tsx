...
export default function MerchantMap({ className = "h-[260px] w-full" }: { className?: string }) {
  ...
  if (!point) {
    return (
      <div className={`flex items-center justify-center rounded-[12px] bg-tile ${className}`}>
  ...
  return <DeliveryMap point={null} merchant={point} interactive={false} className={className} />;
}

...
--
-- AVANT DE LANCER : remplace l'identifiant d'agent ci-dessous par celui de
-- l'agent Break & Lunch (visible dans l'URL du tableau de bord Camille).
--
...
VALUES
  ('aa6d3df4-5000-4c51-8518-40dbaa91f40e', :'agent_id', 'Beignets Haricot Bouillie',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('cc0a1768-416b-41fd-883a-e482b8cbc446', :'agent_id', 'Bouillie de maïs au lait',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('bf115af3-e294-4e69-8b29-cbde6e308434', :'agent_id', 'Omelette spéciale Jojoo',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('bf6b6f4a-c5e4-48be-8011-e1e4e840d853', :'agent_id', 'Sandwich poulet avocat',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('dbf68df1-7bb1-4b7d-8fd3-be6844b0cf9e', :'agent_id', 'Pain perdu caramélisé',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('ce1db76f-b137-4b0a-865c-a9c28c150cbd', :'agent_id', 'Salade de fruits frais',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('e032e8c5-3297-487a-8e5f-3ef2cb379e71', :'agent_id', 'Yaourt maison granola',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('d1d4d441-145b-4522-8693-8411d5cbabda', :'agent_id', 'Café ou thé + croissant',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('323b34de-0322-4a6a-8ba6-8cebe073afe4', :'agent_id', 'Poulet DG',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('658e7e82-f644-47b3-8ae7-16cf67bd7604', :'agent_id', 'Ndolè aux crevettes',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('8aa66cbe-b70d-4d6d-884b-c21a301908e1', :'agent_id', 'Riz sauté au poulet',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('2f46c68c-832f-49b1-859b-b4160d28f086', :'agent_id', 'Poisson braisé plantain',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('a04abc55-ee34-4bdb-8ee7-e3f7a29c7da9', :'agent_id', 'Eru & water fufu',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('fff65234-f6a2-4a11-8a38-6d3b50f943db', :'agent_id', 'Spaghetti sauce bolognaise',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('6dcbe502-d52a-49b6-8594-b0eb9ba93129', :'agent_id', 'Salade César poulet',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('c8e71bf6-df8e-4054-8589-661a6228c7a5', :'agent_id', 'Koki de maïs végétarien',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('1adcb05a-0031-41c6-82a6-3ac0c39182e5', :'agent_id', 'Jus de gingembre',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('05138771-7de5-432b-85e3-34050be08a31', :'agent_id', 'Foléré (bissap) menthe',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('bb366581-5d3a-40b5-8fe7-65a9fcaead47', :'agent_id', 'Jus d''ananas frais',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('c9cea01a-e73d-475f-8105-68fe94357d53', :'agent_id', 'Jus de mangue',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('9c3c4629-0d9c-4ddb-806c-5904f079bb0a', :'agent_id', 'Cocktail tropical',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('9ed661fd-b92c-46dd-8be9-74c8fac435be', :'agent_id', 'Citron gingembre sans sucre',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('493dc086-06aa-4331-88a7-47e1f9ea7e51', :'agent_id', 'Smoothie banane avocat',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('dddf4e2f-5774-449a-8b15-917da6cd24cc', :'agent_id', 'Pack 1 litre au choix',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('97bf0885-db55-4cd8-8a5a-37c0acd9d96e', :'agent_id', 'Formule Break Solo',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('9b33ebe0-6990-48e7-8fb8-498679dc5495', :'agent_id', 'Formule Lunch Solo',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('0a2c58d0-b4c2-4f6b-8619-41f7c78ba058', :'agent_id', 'Formule Duo Journée',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('6551a06d-847b-44cd-8b37-19b845738685', :'agent_id', 'Pack Équipe 10 personnes',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('73c24bb5-6c43-4d9c-853b-bc8faa0178d6', :'agent_id', 'Pack Réunion',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('4d8333d6-d044-4709-8f73-9a787376a0f2', :'agent_id', 'Pause café entreprise',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('654e43e0-8084-45ae-824d-99f6f95d2150', :'agent_id', 'Abonnement mensuel 20 jours',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('8fd79ec3-534f-4b06-8ceb-1ec104f2be43', :'agent_id', 'Formule végétarienne',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('f78ab446-f05d-42a8-8d6e-62c6f43ee2b1', :'agent_id', 'Buffet cocktail 20 personnes',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('821e974e-bef1-4f54-80b0-70b1207af7bd', :'agent_id', 'Plateau de canapés (50 pièces)',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('5ff04f54-1641-484a-84b8-2ccb5d4e6a09', :'agent_id', 'Brochettes party (50 pièces)',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('842d2dd6-0cc0-4dab-81ce-68b977155ae5', :'agent_id', 'Buffet mariage 100 personnes',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('3cc99699-b0b7-46a7-8a0d-2790a9f5423f', :'agent_id', 'Coffee break séminaire',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('56a0e57c-8baf-4124-8d82-edd4155b886b', :'agent_id', 'Pack anniversaire enfant',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('e07a4eaf-2ea5-4f88-873d-308494d4f218', :'agent_id', 'Fontaine à jus (10 L)',
...
INSERT INTO camille.products
  (id, agent_id, name, description, price, price_max, currency, category, tags,
   stock, min_order, image_url, active, sort_order)
VALUES
  ('b0fe109d-e7f4-4935-8145-159b47c4830b', :'agent_id', 'Buffet dessert 30 personnes',
...
UPDATE camille.products SET needs_reindex = true WHERE agent_id = :'agent_id';

COMMIT;

-- Vérification :
--   SELECT category, COUNT(*) FROM camille.products
--    WHERE agent_id = :'agent_id' GROUP BY category ORDER BY category;
